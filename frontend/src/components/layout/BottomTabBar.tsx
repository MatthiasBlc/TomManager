...
export default function BottomTabBar() {
  ...
  const tabs: TabItem[] = [
    {
      to: "/events",
      icon: <TabIcon d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4" />,
      label: "Events",
    },
    {
      to: `/events/${eventId}/planning`,
      icon: <TabIcon d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />,
      label: "Planning",
      show: !!eventId,
    },
    {
