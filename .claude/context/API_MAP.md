...
| Method | Path               | Auth                                  | Description                                                                                                                                                                                                                                                                              |
| ------ | ------------------ | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/`                | requireAuth + requireEventParticipant | Config + roster chef + courses + repas, module par role ; etat par defaut si pas d'EventKitchen (pas de 404). Chaque repas expose `currentUserConflict`/`conflictingCount` (moteur de conflits unifie tables+cuisine, Lot F — cf `services/conflicts.ts`), rendus dans l'onglet Planning |
